package com.TAM.praktikum2.Intent;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "081310949388";
            ...
            case R.id.btn_move_activity_object:
                ...
                mPerson.setName("Ardella Dean");
                mPerson.setAge(20);
                mPerson.setEmail("ardella.da@gmail.com");
                mPerson.setCity("Tangerang");
