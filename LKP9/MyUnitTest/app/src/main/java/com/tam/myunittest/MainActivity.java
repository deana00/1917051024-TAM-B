...
import com.tam.myunittest.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (TextUtils.isEmpty(length)) {
            activityMainBinding.edtLength.setError("This field can't be empty");
        } else if (TextUtils.isEmpty(width)) {
            activityMainBinding.edtWidth.setError("This field can't be empty");
        } else if (TextUtils.isEmpty(height)) {
            activityMainBinding.edtHeight.setError("This field can't be empty");
        } else {
