package com.tam.myalarmmanager;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
    ...
    private EditText editOnceMessage;

    private TextView tvRepeatingTime;
    private EditText editRepeatingMessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editOnceMessage = findViewById(R.id.edit_once_message);
        ...
        editRepeatingMessage = findViewById(R.id.edit_repeating_message);
